...
class TelegramBot:
    ...
    def Iniciar(self):
        ...
        data_atual = str(datetime.today().strftime('%Y-%m-%d'))
    ...
    def agendamento(self,fk_id_servico,desc_servico, fk_id_cliente,nm_cliente,horario_agendado,data_agendamento):
        ...
        cursor.execute(f'''INSERT INTO servicos_agendados(fk_id_servico,desc_servico,fk_id_cliente,nm_cliente,horario_agendado,data_agendamento,desc_status,status) 
                            VALUES ({fk_id_servico}, '{desc}',{fk_id_cliente} ,'{nm_cliente}', '{horario_agendado}','{data_agendamento}', '', 0 )''')
        banco.commit()
